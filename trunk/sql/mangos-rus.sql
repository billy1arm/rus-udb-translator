...
--
-- Хост: localhost
-- Время создания: Июн 14 2009 г., 04:36
...
(1, '2009-06-14 02:43:17', 'mangos', 'creature_ai_texts', 'creature_ai_texts', 1, 1, 559, NULL, NULL, 'В этой таблице содержаться тексты, использующиеся в скриптах eventai. Таблица отвечает за текст, тип отображения(сказать/прокричать/сделать жест) и соответствующие звуки или жесты.'),
(2, '2009-06-12 15:41:55', 'mangos', 'db_script_string', 'db_script_string', 0, 0, 316, NULL, NULL, 'Хранит тексты для скриптов.'),
(3, '2009-06-12 15:38:20', 'mangos', 'locales_achievement_reward', 'achievement_reward', 0, 0, 52, NULL, NULL, 'Данная таблица содержит награды за достижения.'),
(4, '2009-06-14 04:31:18', 'mangos', 'locales_creature', 'creature_template', 19579, 19579, 26300, 'http://www.wowhead.com/?npc=', 'http://ru.wowhead.com/?npc=', 'Таблица используеться для предоставления переведенных названий существ клиентам с определенной локализацией.'),
...
(8, '2009-06-12 17:53:22', 'mangos', 'locales_npc_text', 'npc_text', 3573, 3490, 5123, NULL, NULL, 'Таблица используеться для предоставления переведенных текстов НИП клиентам с определенной локализацией.'),
